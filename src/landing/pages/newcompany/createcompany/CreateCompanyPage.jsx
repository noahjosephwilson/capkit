      ...
      <div className={styles["left-container"]}>
        ...
        <div className={styles["ccd-header"]}>
          <div
            ...
            onClick={() => router.push("/landing/newcompany/home")}
          >
            <svg
              width="24"
              height="24"
        ...
        <div className={styles["ccd-content"]}>
          ...
          {error && (
            <div className={styles["ccd-error"]}>
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className={styles["ccd-form"]}>
            ...
            <div className={styles["ccd-image-upload-container"]}>
              <div className={styles["ccd-image-preview-container"]}>
                {previewUrl ? (
                  <img
                    src={previewUrl}
                    alt="Profile Preview"
                    className={styles["ccd-image-preview"]}
                  />
                ) : (
                  <div className={styles["ccd-image-placeholder"]}>Preview</div>
                )}
              </div>
              <label htmlFor="companyImage" className={styles["ccd-file-button"]}>
                Choose File
              </label>
              <input
                type="file"
            ...
            <button
              type="submit"
              className={styles["ccd-submit-button"]}
