  ...
  return (
    <div className={styles["login-page-container"]}>
      ...
      <div className={styles["login-card"]}>
        ...
        <div className={styles["forgot-password-inline"]}>
          <button 
            type="button" 
        ...
        {showResetForm && (
          <form onSubmit={handleForgotPassword} className={styles["reset-form"]}>
            <div className={styles["input-group"]}>
              <label htmlFor="resetEmail" className={styles["input-label"]}>Enter your email</label>
              <input
                type="email"
                id="resetEmail"
                className={styles["input-field"]}
            ...
            <button type="submit" className={styles["login-btn"]}>Send Reset Email</button>
            {resetMessage && <div className={styles["reset-message"]}>{resetMessage}</div>}
          </form>
        )}
        ...
        <div className={styles["create-account-container"]}>
          <p>
            ...
            <Link href="/landing/registration/signup">
              <span className={styles["create-account-link"]}>Create Account</span>
            </Link>
          </p>
        </div>
      </div>
