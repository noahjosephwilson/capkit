    ...
    <div className={styles.employeeReleasesPage}>
      <header className={styles.header}>
        ...
        <div className={styles.tabContainer}>
          <button
            className={`${styles.tabButton} ${selectedTab === "past" ? styles.activeTab : ""}`}
            onClick={() => setSelectedTab("past")}
          >
            Past Releases
          </button>
          <button
            className={`${styles.tabButton} ${selectedTab === "new" ? styles.activeTab : ""}`}
            onClick={() => setSelectedTab("new")}
          >
            New Release
          </button>
          <button
            className={`${styles.tabButton} ${selectedTab === "disputes" ? styles.activeTab : ""}`}
      ...
      <div className={styles.content}>
        {selectedTab === "past" && (
          <div className={styles.section}>
            <h2>Past Releases</h2>
            {/* Replace with your list of past releases */}
            <p>No past releases available.</p>
          </div>
        )}
        ...
        {selectedTab === "disputes" && (
          <div className={styles.section}>
            <h2>Disputes</h2>
            {/* Replace with your disputes information */}
            <p>No disputes currently.</p>
          </div>
        )}

        {selectedTab === "new" && (
          <div className={styles.section}>
            <h2>New Employee Release</h2>
